...
import 'package:food_delivery_owner/src/elements/ShoppingCartButtonWidget.dart';
import '../controllers/restaurant_controller.dart';
import '../elements/FoodItem.dart';
...
class _AddOrderWidgetState extends StateMVC<AddOrderWidget> {
  RestaurantController? _con;
  List<String>? selectedCategories;

  _AddOrderWidgetState() : super(RestaurantController()) {
    _con = controller as RestaurantController?;
  }

  @override
  void initState() {
    _con!.restaurant = currentUser.value.restaurant!;
